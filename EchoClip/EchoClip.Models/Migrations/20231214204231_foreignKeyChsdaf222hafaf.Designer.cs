...
namespace EchoClip.Models.Migrations
{
    ...
    [Migration("20231214204231_foreignKeyChsdaf222hafaf")]
    partial class foreignKeyChsdaf222hafaf
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("EchoClip.Models.ChatsVoiceRecordings", b =>
                {
                    ...
                    b.Property<Guid>("Voice_recordinSSgsVoide_recoding_id")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("Voice_recordinSSgsVoide_recoding_id");
            ...
            modelBuilder.Entity("EchoClip.Models.ChatsVoiceRecordings", b =>
                {
                    ...
                    b.HasOne("EchoClip.Models.VoiceRecordings", null)
                        .WithMany()
                        .HasForeignKey("Voice_recordinSSgsVoide_recoding_id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
